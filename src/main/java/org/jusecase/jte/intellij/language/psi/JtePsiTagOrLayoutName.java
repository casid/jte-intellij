...
public abstract class JtePsiTagOrLayoutName extends JtePsiElement implements PsiNamedElement {
    public JtePsiTagOrLayoutName(@NotNull ASTNode node) {
        super(node);
    }

    public abstract String getIdentifier();

    private boolean matchesParent(PsiDirectory parent, JtePsiTagOrLayoutName prevName) {
        if (parent == null) {
            return false;
        }
    ...
    private PsiReference resolveDirectoryReference() {
        ...
        while (nextDirectory != null) {
            ...
            nextSibling = PsiTreeUtil.getNextSiblingOfType(nextSibling, JtePsiTagOrLayoutName.class);
    ...
    private PsiReference createDirectoryReference(PsiDirectory directory) {
        return new PsiReference() {
            ...
            public PsiElement getElement() {
                return JtePsiTagOrLayoutName.this;
            }
    ...
    private PsiFile resolveFile(JtePsiTagOrLayoutName fileElement) {
        JtePsiTagOrLayoutName prevName = PsiTreeUtil.getPrevSiblingOfType(fileElement, getClass());
    ...
    public JtePsiTagOrLayoutName resolveFileElement(JtePsiTagOrLayoutName element) {
        JtePsiTagOrLayoutName sibling = PsiTreeUtil.getNextSiblingOfType(element, JtePsiTagOrLayoutName.class);
        if (sibling == null) {
            return element;
        } else {
