 ...
 * @author peter
 */
public class PatchedTemplateDataElementType extends IFileElementType implements ITemplateDataElementType {
    ...
    public PatchedTemplateDataElementType(@NonNls String debugName,
                                   Language language,
